...
class DBHelper {
  ...
  static final _lessons = [
    Lesson(
        course: _courses[0],
        teacher: _teachers[0],
        dateTime: DateTime.parse("2022-11-28 15:00")),
    Lesson(
        course: _courses[0],
        teacher: _teachers[1],
        dateTime: DateTime.parse("2022-11-28 15:00")),
    ...
    Lesson(
        course: _courses[1],
        teacher: _teachers[0],
        dateTime: DateTime.parse("2022-11-28 16:00")),
    Lesson(
        course: _courses[1],
        teacher: _teachers[5],
        dateTime: DateTime.parse("2022-11-28 16:00")),
    ...
    Lesson(
        course: _courses[2],
        teacher: _teachers[3],
        dateTime: DateTime.parse("2022-11-28 17:00")),
    Lesson(
        course: _courses[2],
        teacher: _teachers[5],
        dateTime: DateTime.parse("2022-11-28 17:00")),
    Lesson(
        course: _courses[3],
        teacher: _teachers[1],
        dateTime: DateTime.parse("2022-11-28 18:00")),
    Lesson(
        course: _courses[4],
        teacher: _teachers[1],
        dateTime: DateTime.parse("2022-11-28 19:00")),
  ];
